...
$APPLICATION->SetPageProperty("description", "После ввода необходимой информации о доставке товара (ФИО получателя, адрес доставки, контактные данные, вариант доставки, способ оплаты и т.д) для оформления заказа Вам нужно нажать кнопку Оформить заказ.");
$APPLICATION->SetTitle("Как купить");?><p>
	Данный сайт является демо-версией готового интернет-магазина&nbsp;для 1С-Битрикс. Вся информация на сайте не является офертой, а служит лишь примером наполнения для ознакомления с возможностями решения.
</p>
