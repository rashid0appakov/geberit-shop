        ...
        <div class="columns">
            <div class="description column is-6">
                <h2 class="animate-partner-left is-size-3">
                    <?$APPLICATION->IncludeComponent(
                        ...
                        array(
                            "AREA_FILE_SHOW" => "file",
                            "PATH" => SITE_DIR."include/main_partners/title.php",
                        ),
                        false
                    );?>
                </h2>
                <?$APPLICATION->IncludeComponent(
                    ...
                    array(
                        "AREA_FILE_SHOW" => "file",
                        "PATH" => SITE_DIR."include/main_partners/description.php",
                    ),
                    false
                );?>
                <?$APPLICATION->IncludeComponent(
                    ...
                    array(
                        "AREA_FILE_SHOW" => "file",
                        "PATH" => SITE_DIR."include/main_partners/more.php",
                    ),
                    false
                );?>
            </div>
			...
			<div class="partners-video">
                <?$APPLICATION->IncludeComponent(
                    ...
                    array(
                        "AREA_FILE_SHOW" => "file",
                        "PATH" => SITE_DIR."include/main_partners/video.php",
                    ),
                    false
                );?>
			</div>
