...
// Настройки
$url = 'http://sypexgeo.net/files/SxGeoCity_utf8.zip';  // Путь к скачиваемому файлу
$dat_file_dir = $_SERVER['DOCUMENT_ROOT'].'/upload/db/'; // Каталог в который сохранять dat-файл
$last_updated_file = __DIR__ . '/../pid/SxGeo.upd'; // Файл в котором хранится дата последнего обновления
