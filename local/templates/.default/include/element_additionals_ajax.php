...
$arResult['PROPERTIES']['ADDITIONAL']['VALUE'] = json_decode($_REQUEST['prop1'],true);
$arResult['PROPERTIES']['ADDITIONAL_CACHE']['~VALUE'] = $_REQUEST['prop2'];
...
foreach( $arResult['ADDITIONAL'] AS $key => &$sec){
    ...
    $rightArrowId .= '_'.$i;
    ?>
    <div class="content tabs__content js-tabs-content2<?=strpos($active,$i)!==false?' active':''?>" id="tab-goods_add_<?=$i;?>">
