		...
		<div class="goods__wrapper">
			...
			<div class="goods__card">
				<?php
					...
					$arFilter = Array("IBLOCK_ID"=>IntVal($arParams["IBLOCK_ID"]), "ACTIVE_DATE"=>"Y", "ACTIVE"=>"Y", 'PROPERTY_BRAND' => $man_show);
					...
					$arrSFilter['ID'] = $ID;
					?>
					<?$APPLICATION->ShowViewContent("POPULAR");?>
				<?if(isset($_GET['letter'])&&strlen($_GET['letter'])>0){
					$GLOBALS['arrSFilter']['NAME']= $_GET['letter'].'%';
				}

				global $man_show;
				$GLOBALS['arrSFilter']['PROPERTY_BRAND'] = $man_show;
