...
$(document).ready(function () {
	if ($('.goods__card-sort-filter').length){
		$(document).on('click', '.goods__card-sort-filter', function(e) {
			SC.mobileMenuOpened();
	...
	if ($('.goods__filter-close-button').length){
		$(document).on('click', '.goods__filter-close-button', function(e) {
			SC.mobileMenuClosed();
	...
	$(document).on('click', '.page_product_viewed_button_compare', function(e) {
