...
//pr($_REQUEST);
$q = intval(trim($_REQUEST['q']));

if($q > 0 and $q == $_REQUEST['q'])
{
	$arSelect = Array("ID", "IBLOCK_ID", "ACTIVE", "DETAIL_PAGE_URL", "NAME");
	$arFilter = Array("ID" => $q, "IBLOCK_ID" => $arParams["IBLOCK_ID"], "ACTIVE_DATE"=>"Y", "ACTIVE"=>"Y");
...
<div class="goods">
	<div class="container goods__container">
		...
		<div class="goods__wrapper">
			<div class="goods__card preview-products">
				<?
				$APPLICATION->IncludeComponent(
					...
					array(
						...
						"USE_LANGUAGE_GUESS" => !empty($arParams["SEARCH_USE_LANGUAGE_GUESS"]) ? $arParams["SEARCH_USE_LANGUAGE_GUESS"] : "N",
...
<?
$APPLICATION->SetTitle('Поиск по запросу «'.$_GET['q'].'»');
$APPLICATION->SetPageProperty('title', 'Поиск по запросу «'.$_GET['q'].'»');
