			...
			<div class="logos columns is-mobile is-gapless is-multiline has-text-centered">
				<?for ($bi = 0; $bi < 8; $bi++, $i++):
					...
					<div class="column is-4">
						<a href="<?=$arItem["DISPLAY_PROPERTIES"]["BRAND"]["LINK_ELEMENT_VALUE"][$arItem["DISPLAY_PROPERTIES"]["BRAND"]["VALUE"]]["DETAIL_PAGE_URL"]?>">
							<img class="animate-partner" src="<?=$arItem["DETAIL_PICTURE"]["SRC"]?>">
						</a>
					</div>
				<?endfor;?>
