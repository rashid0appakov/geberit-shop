                    ...
                    <div id="delivery_form_MKAD" style="display: none;">
                        ...
                        <div class="delivery-for-MKAD">
                            <div class="filter__checkbox">
                                <input id="delivery-for-MKAD" type="checkbox" autocomplete="off" data-price="<?=(int)$arParams['OUTSIDE_MKAD_PRICE']?>" name="ORDER_PROP_25" onclick="$(this).attr('value', this.checked ? 'Да' : 'Нет')" value="Нет"/>
                                <label for="delivery-for-MKAD">Нужна доставка за МКАД</label>
                            </div>
                        </div>
                        <div class="delivery-for-MKAD">
                        	Ознакомиться с тарифами вы можете <a href="/delivery/">в разделе доставки</a>
                        	<input type="hidden" id="select-mkad-km"/>
                        </div>
...
*/?>
                                <input id="ORDER_PROP_1" name="ORDER_PROP_3" type="text" class="mobMarginNull" placeholder="7(" value="<?=$arResult['USER_VALS']['ORDER_PROP'][3] ?>" required="" />
                                <script>
                                    $(".mobMarginNull").mask("7(999)999-9999")
                                </script>
                            </div>
                        </div>
                        <div class="column">
					...
					<div class="input_adres" style="display:none;">
						...
						<div class="columns">
							<div class="column">
								<div class="inputCity">
									<label for="ORDER_PROP_6">Город <span class="red-star">*</span></label>
                                    <?$APPLICATION->IncludeComponent(
                                        "bitrix:sale.location.selector.search",
                                        "",
                                        Array(
                                            "COMPONENT_TEMPLATE" => ".default",
                                            "ID" => ($regionId ? $regionId : $DEFAULT_GEOLOCATION_ID),
                                            "CODE" => "",
									...
									<?/*/?><input id="ORDER_PROP_6" name="ORDER_PROP_6" type="text" placeholder="" value="<?= $arResult['USER_VALS']['ORDER_PROP'][6] ?>" /><?/**/?>
								</div>
							</div>
                        </div>
                        <?}?>
        ...
        <div class="columns">
            <div class="service himselfBlock column is-10" >
                <div class="titleBlockHimself">
                    <p>Сервис и услуги</p>
                </div>
                <div class="listDelivery columns">
