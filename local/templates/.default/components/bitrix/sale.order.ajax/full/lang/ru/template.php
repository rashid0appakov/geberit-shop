...
$MESS["SOA_SELF_DELIVERY_NOTE"] = "Вы можете самостоятельно забрать заказ из одного из наших <a href=\"#LINK#\" target=\"_blank\">магазинов</a>.";
$MESS["SOA_TC_DELIVERY_NOTE"]   = "Доставка осуществляется до терминала транспортной компании. Стоимость доставки до вашего города по тарифам транспортной компании.";
?>
