<?php
	...
	$MESS ['TSB1_TOTAL_PRICE'] = "Сумма зказа";
	...
	$MESS ['TSB1_TOTAL'] = "Итого";
	$MESS ['TSB2_EMPTY'] = "Корзина пуста";
	$MESS ['TSB1_EMPTY']	= "корзина пуста";
	$MESS ['TSB_TEXT']   = "В вашей корзине ";

	$MESS ['TSB_COUNT']   = "Кол-во позиций";
	$MESS ['TSB_QTY']	   = "ед.";

	$MESS ['TSB_CONTINUE']   = "Продолжить покупки";
