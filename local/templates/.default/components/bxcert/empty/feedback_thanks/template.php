		...
		<div class="columns">
			<div class="column">
				<div class="inputText">
					...
					<textarea id="<?=$textInputId?>" name="text" id="" cols="30" rows="10" required></textarea>
				</div>
			</div>
		</div>
	</div>
...
<script>
	window.feedbackThanks = new JSFeedbackThanks(<?=json_encode($jsParams)?>);
</script>