		...
		<div class="container is-widescreen">
			<div class="columns is-mobile">
				...
				<div class="phone column custom-live-ajax-update" id="custom-live-ajax-update-header-phone2">
					...
					<span class="call_phone_1"><a class="phone sezmask" href="tel:<?=$arContact['PHONE']['NUMBER']?>"><?=$arContact['PHONE']['VALUE']?></a></span>
		...
		<div class="container is-widescreen">
			<div class="columns is-mobile">
				...
				<div class="phone column is-2 custom-live-ajax-update" id="custom-live-ajax-update-header-phone">
						...
						<span class="call_phone_1"><a href="tel:<?=$arContact['PHONE']['NUMBER']?>" class="call sezmask"><?=$arContact['PHONE']['VALUE']?></a></span>
	...
	<div id="bottom-header" class="bottom-header hero">
		<div class="container is-widescreen">
			<div class="columns is-mobile">
				...
				<span class="m_call_phone_1"><a href="tel:<?=$arContact['PHONE']['NUMBER']?>" class="mobile-phone-button search bottom-header__search _popup-catalog-menu-start-mobile-button--bottom-header sezmask"
				...
				<div class="phone column">
					...
					<span class="m_call_phone_1"><a class="phone sezmask" href="tel:<?=$arContact['PHONE']['NUMBER']?>"><?=$arContact['PHONE']['VALUE']?></a></span>
					<span class="work"><?=$arContact['SCHEDULE']?></span>
