		...
		<div class="container is-widescreen">
			<div class="columns is-mobile">
				...
				<div class="phone column custom-live-ajax-update" id="custom-live-ajax-update-header-phone2">
					...
					<span class="call_phone_1"><a class="phone vbmsk" href="tel:<?=$arContact['PHONE']['NUMBER']?>"><?=$arContact['PHONE']['VALUE']?></a></span>
		...
		<div class="container is-widescreen">
			<div class="columns is-mobile">
				...
				<div class="phone column is-2 custom-live-ajax-update" id="custom-live-ajax-update-header-phone">
						...
						<span class="call_phone_1"><a href="tel:<?=$arContact['PHONE']['NUMBER']?>" class="call vbmsk"><?=$arContact['PHONE']['VALUE']?></a></span>
	...
	<div id="bottom-header" class="bottom-header hero">
		<div class="container is-widescreen">
			<div class="columns is-mobile">
				...
				<span class="m_call_phone_1"><a href="tel:<?=$arContact['PHONE']['NUMBER']?>" class="mobile-phone-button search bottom-header__search _popup-catalog-menu-start-mobile-button--bottom-header vbmsk"
				...
				<div class="pack column">
					...
					<a href="https://swet-online.ru/" target="_blank" class="navbar-link" title="<?=GetMessage('HDR_MENU_LIGHT_LABEL')?>">
						...
						<span><?=GetMessage('HDR_MENU_LIGHT_LABEL')?></span>
					</a><?endif;?>
					...
					<a href="https://tiptop-shop.ru/" target="_blank" class="navbar-link" title="<?=GetMessage('HDR_MENU_TIPTOP_LABEL')?>">
						...
						<span><?=GetMessage('HDR_MENU_TIPTOP_LABEL')?></span>
					</a><?endif;?>
				</div>
				<div class="install column">
					...
					<a href="https://gazkomfort.ru/" target="_blank" class="navbar-link" title="<?=GetMessage('HDR_MENU_GAZ_LABEL')?>">
						...
						<span><?=GetMessage('HDR_MENU_GAZ_LABEL')?></span>
					</a><?endif;?>
				</div>
				<div class="phone column">
					<? Bitrix\Main\Page\Frame::getInstance()->startDynamicWithID("contacts_header_2");?>
					<span class="m_call_phone_1"><a class="phone vbmsk" href="tel:<?=$arContact['PHONE']['NUMBER']?>"><?=$arContact['PHONE']['VALUE']?></a></span>
					<span class="work"><?=$arContact['SCHEDULE']?></span>
