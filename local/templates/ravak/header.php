	...
	<div id="bottom-header" class="bottom-header hero">
		<div class="container is-widescreen">
			<div class="columns is-mobile">
				...
				<span class="m_call_phone_1"><a href="tel:<?=$arContact['PHONE']['NUMBER']?>" class="mobile-phone-button search bottom-header__search _popup-catalog-menu-start-mobile-button--bottom-header <?=$arContact['CLASS_ROISTAT']?>"
				...
				<div class="phone column">
					...
					<span class="m_call_phone_1"><a class="phone <?=$arContact['CLASS_ROISTAT']?>" href="tel:<?=$arContact['PHONE']['NUMBER']?>"><?=$arContact['PHONE']['VALUE']?></a></span>
					<span class="work"><?=$arContact['SCHEDULE']?></span>
