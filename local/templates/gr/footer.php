<?php
	...
	$arAllContacts = CClass::getContactsData(TRUE);
	$arContactMap = array(129, 768, 2200);
?>
			...
			<div class="columns is-mobile">
				<div class="column custom-live-ajax-update" id="custom-live-ajax-update-footer-address2">
					...
					if(empty($_SERVER['HTTP_IS_SUB_HEADER'])){
						foreach($arContactMap as $itemId){
							?>
							<span class="call_phone_2"><a class="phone" href="tel:<?=$arAllContacts[$itemId]['PHONE']?>"><?=$arAllContacts[$itemId]['PHONE']?></a></span><br />
							<?
						}
						?>
						<span class="call_phone_2"><a class="phone" href="tel:<?=$arContact['ADD_PHONE']['NUMBER']?>"><?=$arContact['ADD_PHONE']['VALUE']?></a></span><br />
						<?
					}
					else{
						?>
						<h4 class="is-size-5">Центральный офис</h4>
						<p class="address"><?=$arContact['ADRESS']?></p>
						
						<span class="call_phone_2"></span><br />
		...
		<div class="container is-widescreen">
			<div class="columns is-mobile custom-live-ajax-update" id="custom-live-ajax-update-footer-address3">
				...
				if(empty($_SERVER['HTTP_IS_SUB_HEADER'])){
					...
					<div class="column phone-column">
						<span class="call_phone_5"><a class="phone" href="tel:<?=$arContact['ADD_PHONE']['NUMBER']?>"><?=$arContact['ADD_PHONE']['VALUE']?></a></span>
						<?if(!empty($arSite["EMAIL"])){?><a class="email" href="mailto:<?=$arSite["EMAIL"]?>"><?=$arSite["EMAIL"]?></a><?}?>
					</div>
					<?
				}
				...
				<div class="container">
					<div class="toolbar-bottom__content">
						...
						<div class="toolbar-bottom__phone custom-live-ajax-update" id="custom-live-ajax-update-footer-phone">
							...
							if(empty($_SERVER['HTTP_IS_SUB_HEADER'])){
								?>
								<span class="call_phone_3"><a href="tel:<?=$arContact['ADD_PHONE']['NUMBER']?>" class="toolbar-bottom__phone-number"><?=$arContact['ADD_PHONE']['VALUE']?></a></span>
								<?
							}
							else{
								?>
