...
?>
		...
		<div class="container is-widescreen">
			<div class="columns is-mobile">
				<div class="column custom-live-ajax-update" id="custom-live-ajax-update-footer-address2">
					...
					<a class="phone <?=$arContact['CLASS_ROISTAT']?>" href="tel:<?=$arContact['PHONE']['NUMBER']?>"><?=$arContact['PHONE']['VALUE']?></a><br />
					<? Bitrix\Main\Page\Frame::getInstance()->finishDynamicWithID("phone_footer_1", "");?>
					<?if(!empty($arContact['ADD_PHONE']['NUMBER'])){?><a class="phone" href="tel:<?=$arContact['ADD_PHONE']['NUMBER']?>"><?=$arContact['ADD_PHONE']['VALUE']?></a><?}?>
				...
				<div class="container">
					<div class="toolbar-bottom__content">
						...
						<div class="toolbar-bottom__phone custom-live-ajax-update" id="custom-live-ajax-update-footer-phone">
							...
							<a href="tel:<?=$arContact['PHONE']['NUMBER']?>" class="toolbar-bottom__phone-number <?=$arContact['CLASS_ROISTAT']?>"><?=$arContact['PHONE']['VALUE']?></a>
	...
	<div class="popup-menu" id="popup-main-main-menu">
		<div class="middle-header hero">
			<div class="container is-widescreen">
				<div class="columns is-mobile custom-live-ajax-update" id="custom-live-ajax-update-footer-phone2">
		...
		<div class="footer-top hero mobile">
			<div class="container is-widescreen custom-live-ajax-update" id="custom-live-ajax-update-footer-phone3">
				<p class="address"><?=Option::get("tiptop", "template_address", "")?></p>
				<div class="columns is-mobile">
