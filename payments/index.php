...
$APPLICATION->SetPageProperty("description", "Geberit Shop");
$APPLICATION->SetPageProperty("keywords", "оплата, грое, Geberit Shop");
    $APPLICATION->SetPageProperty("title", "Способы оплаты товаров в магазине Geberit Shop");
			...
			<div class="goods__card">
                ...
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        ...
                        "CACHE_TYPE" => "A",
                        "COUNT_ELEMENTS" => "N",
                        "IBLOCK_ID" => CClass::RU_PAYMENTS_IBLOCK_ID,
                        "IBLOCK_TYPE" => "content",
                        "SECTION_CODE" => "",
                        "SECTION_FIELDS" => array(0=>"NAME",1=>"CODE",2=>"DESCRIPTION"),
                        "SECTION_ID" => PAYMENT_SECTION_ID,
                        "SECTION_URL" => "",
